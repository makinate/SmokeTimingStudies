...
switch screen_name
    ...
    case 'maxLab'  % this is a Asus VS238H-P
        ...
        scr.exp         = input('Enter experiment name:','s');        
        
        if scr.exp == 'VSS'
            
            scr.image_dir = 'E:/Dropbox/Dartmouth/Smoke/Manta/render_out/VSS/new_speeds';
            
        elseif scr.exp == 'Exp2'
            
            scr.image_dir = 'E:/Dropbox/Dartmouth/Smoke/Manta/render_out/exp2';
            
        else
            
            error('invalid experiment name; no image dir specified');
