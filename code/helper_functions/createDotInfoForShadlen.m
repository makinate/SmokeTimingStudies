function dotInfo = createDotInfoForShadlen(dat,coherence,direction)
...
dotInfo.apXYD       = [0 0 10*2*dat.stimRadDeg];  
dotInfo.speed       = 10*dat.dotSpeedDegPerSec;
...
dotInfo.maxDotTime  = dat.trial_sec;
...
% dot size in pixels
dotInfo.dotSize = dat.stm.dotSizePix;
